...
* Copies static files to the output folder (`copy.js`)
* Creates application bundles with Webpack (`bundle.js`, `webpack.payConfig.js`)
...
* `webpack.payConfig.js` - Webpack configuration for both client-side and server-side bundles
